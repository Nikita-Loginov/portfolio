...
import { LiquidEtherConfig } from "@/shared/config/animations/types";
import * as THREE from "three";

import scss from "./LiquidEther.module.scss";
...
type LiquidEtherProps = LiquidEtherConfig
